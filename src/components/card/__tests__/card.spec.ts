...
describe("Card", () => {
  ...
  it("renders slot", () => {
    ...
    expect(wrapper.find(".ja-card__header").html()).toContain(
      "<div>Header</div>"
    );
    expect(wrapper.find(".ja-card__footer").html()).toContain(
      "<div>Footer</div>"
    );
    expect(wrapper.find(".ja-card__actions").html()).toContain(
      "<div>Actions</div>"
    );
